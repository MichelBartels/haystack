            ...
            if doc_id in aggregated_per_doc:
                for label in aggregated_per_doc[doc_id]:
                    ...
                    if label.answer.offsets_in_document is None:
                        ...
                        if query_key in aggregated_per_question.keys():
                            if label.no_answer:
                                continue
                            else:
                                ...
                                if len(aggregated_per_question[query_key]["answers"]) >= 6:
